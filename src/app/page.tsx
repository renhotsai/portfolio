...
export const metadata: Metadata = {
  title: "Jeremy Tsai — Backend & Full-Stack Engineer",
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center text-center px-4 py-12 md:py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <MotionWrap as="h2" delay={0.15} className="text-xl md:text-2xl lg:text-3xl font-semibold mb-6 md:mb-8 text-muted-foreground">
          Backend Engineer · Full-Stack · AWS / Azure Cloud
        </MotionWrap>
        <MotionWrap delay={0.18} className="mb-6 md:mb-8 flex justify-center">
          <OpenToWork />
        </MotionWrap>
        <MotionWrap
          as="p"
        ...
        <MotionWrap delay={0.3} className="mb-8 md:mb-12">
        ...
        <MotionWrap delay={0.35} className="mt-8 md:mt-12">
