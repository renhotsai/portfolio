							...
							<Card key={cert.id} className="transition-all duration-300 hover:shadow-md">
								<CardContent className="p-3">
									<div className="flex items-center justify-between gap-3">
										...
										<Link href={cert.pdfUrl ?? cert.externalUrl!} target="_blank" rel="noopener noreferrer">
								...
								<div className="lg:col-span-3 order-2 lg:order-1 p-6 border-b lg:border-b-0 lg:border-r">
									<div className="space-y-4">
										...
										{selectedCertificate.pdfUrl ? (
											...
											<div className="flex flex-col items-center justify-center h-[300px] gap-4 text-center border rounded-lg bg-muted/30">
												<p className="text-muted-foreground text-sm">
													This certification is hosted externally and can be verified online.
												</p>
												<Link href={selectedCertificate.externalUrl!} target="_blank" rel="noopener noreferrer">
...
export default CertificatesClientPage;
