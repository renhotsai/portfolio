...
export const projectsData: Record<string, ProjectDetail> = {
  ...
  "fly-panner": {
    ...
    description: "Born from a personal frustration of manually checking flight prices day after day, Fly Panner lets you define a flexible date range, instantly scans every date combination via Duffel Air API, and subscribes you to weekly email alerts. Grown to 200+ users — built AI-first with Claude Code, backed by PostgreSQL and Resend.",
    ...
    imageUrl: "/Images/fly-planner-0.jpg",
    images: [
      {
        url: "/Images/fly-planner-0.jpg",
    ...
    features: [
      ...
      "Grew to 200+ active users since launch",
